...
public class SentimentDriver extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		// Here, the logger describes the job.
		LOG.info(
				"---- Sentiment Analysis using Tweets about the Clippers and Finn's affective valence lookup table ------- ");
		/*
		 * Use the logger to log your name and group
		 */
		/*
		 * TODO implement
		 */
		LOG.info("Name: Meng Ting Chang, Group: #2");

		/*
		 * Get the Configuration and give it the name of the lookup table WARNING -- Please, set properties on the
		 * Configuration object before you create the job.
		 */
		Configuration conf = getConf();
		conf.set(LOOKUP_PROPERTY_NAME, new File(lookupTable).getName());
		 ...
		 * 
		 * URI[] cacheFiles = { new URI(lookupTable) }; job.setCacheFiles(cacheFiles);
		 * 
		 * setCacheFiles(
		 * 
		 */
		 ...
		 * 
		 * Use the job.setConfiguration function.
		 * 
		 */
		/*
		 * TODO implement
